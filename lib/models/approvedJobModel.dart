...
class ApprovedJobModel {
  List<JobData>? data;

  ApprovedJobModel({this.data});

  ApprovedJobModel.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = [];
      json['data'].forEach((v) {
...
class JobData {
  ...
  JobData.fromJson(Map<String, dynamic> json) {
    ...
    jobApplicantStatus = json['jobApplicantStatus'] ?? 'not started';
